function exp_array=expand_array(node_x,node_y,hn,xTarget,yTarget,CLOSED,MAX_X,MAX_Y,Map_Occup,NumAGV)
...
%                        exp_array(exp_count,4) = distance(xTarget,yTarget,s_x,s_y)+Map_Occup(node_x,node_y)/NumAGV; %考虑占用情况的启发式规则
