...
%% 导入数据
% load PBS_r_34_c_26_OptValue.mat
load PBS_random-64-64-10_OptValue.mat
% 随机产生训练集和测试集
n = randperm(size(Attributes,2));
% 训练集——200个样本
num_test = ceil(0.8*size(Attributes,2));
...
%% 保存训练结果
%save('OptModel_4PBS_r_34_c_26_SVM.mat','model','inputps','outputps');
save('OptModel_4PBS_random-64-64-10_SVM.mat','model','inputps','outputps');
